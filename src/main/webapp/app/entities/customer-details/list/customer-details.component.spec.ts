...
import { sampleWithRequiredData } from '../customer-details.test-samples';
...
describe('CustomerDetails Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, CustomerDetailsComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to customerDetailsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCustomerDetailsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCustomerDetailsIdentifier).toHaveBeenCalledWith(entity);
