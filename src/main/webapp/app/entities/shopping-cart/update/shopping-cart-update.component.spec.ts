...
describe('ShoppingCart Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, ShoppingCartUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call CustomerDetails query and add missing value', () => {
      ...
      const customerDetails: ICustomerDetails = { id: 32281 };
      shoppingCart.customerDetails = customerDetails;

      const customerDetailsCollection: ICustomerDetails[] = [{ id: 667 }];
    ...
    it('Should update editForm', () => {
      const shoppingCart: IShoppingCart = { id: 456 };
      const customerDetails: ICustomerDetails = { id: 25037 };
      shoppingCart.customerDetails = customerDetails;
