...
describe('Product Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call ProductCategory query and add missing value', () => {
      ...
      const productCategory: IProductCategory = { id: 3894 };
      product.productCategory = productCategory;

      const productCategoryCollection: IProductCategory[] = [{ id: 20628 }];
    ...
    it('Should update editForm', () => {
      const product: IProduct = { id: 456 };
      const productCategory: IProductCategory = { id: 13948 };
      product.productCategory = productCategory;
