...
describe('ProductOrder Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, ProductOrderUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call Product query and add missing value', () => {
      ...
      const product: IProduct = { id: 27491 };
      productOrder.product = product;

      const productCollection: IProduct[] = [{ id: 6718 }];
    ...
    it('Should call ShoppingCart query and add missing value', () => {
      const productOrder: IProductOrder = { id: 456 };
      const cart: IShoppingCart = { id: 29429 };
      productOrder.cart = cart;

      const shoppingCartCollection: IShoppingCart[] = [{ id: 26143 }];
    ...
    it('Should update editForm', () => {
      const productOrder: IProductOrder = { id: 456 };
      const product: IProduct = { id: 13455 };
      productOrder.product = product;
      const cart: IShoppingCart = { id: 1540 };
      productOrder.cart = cart;
