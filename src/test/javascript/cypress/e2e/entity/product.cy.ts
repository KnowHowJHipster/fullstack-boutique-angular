...
describe('Product e2e test', () => {
  ...
  const productSample = { name: 'shocked', price: 4391.45, productSize: 'M' };
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: { name: 'nicely rewarding', description: 'tattered impeccable whereas' },
    }).then(({ body }) => {
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="name"]`).type('meal midst smash');
      cy.get(`[data-cy="name"]`).should('have.value', 'meal midst smash');

      cy.get(`[data-cy="description"]`).type('steam midst vacillate');
      cy.get(`[data-cy="description"]`).should('have.value', 'steam midst vacillate');

      cy.get(`[data-cy="price"]`).type('29659.59');
      cy.get(`[data-cy="price"]`).should('have.value', '29659.59');
