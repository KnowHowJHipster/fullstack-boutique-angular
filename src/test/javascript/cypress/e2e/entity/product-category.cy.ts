...
describe('ProductCategory e2e test', () => {
  ...
  const productCategorySample = { name: 'simplistic' };
  ...
  describe('new ProductCategory page', () => {
    ...
    it('should create an instance of ProductCategory', () => {
      cy.get(`[data-cy="name"]`).type('abridge');
      cy.get(`[data-cy="name"]`).should('have.value', 'abridge');

      cy.get(`[data-cy="description"]`).type('tsunami taut torn');
      cy.get(`[data-cy="description"]`).should('have.value', 'tsunami taut torn');
