...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'd34dfdb3-6f09-4578-94b4-d4faa40d8e76' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('00fed137-53f0-414b-865e-727f3b1ebed0');
      cy.get(`[data-cy="name"]`).should('have.value', '00fed137-53f0-414b-865e-727f3b1ebed0');
